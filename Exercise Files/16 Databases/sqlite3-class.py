...
import sqlite3
#The class objects will be used while we actually use this database appliction
class database:
    ...
    def close(self):
            self._db.close()
            del self._filename
#The main function shall be used only for the purpose of testing while we try to see the results of the application we have created
def main():
